...
if (@$_GET ['delete'] == 'true') {
    if ($objModelCar->delete($_GET['brand_id'], $_GET['id']))
                            ...
                            <table class="table .table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($arrModel as $row) {
                                        ...
                                        <tr>
                                            <td>
                                                <a href="editCarModel.php?id=<?php echo $row->model_id; ?>&brand_id=<?php echo $row->brand_id; ?>"<button type="button" class="btn btn-warning">แก้ไข&nbsp;</button></a>
                                                <a href="?delete=true&id=<?php echo $row->model_id; ?>&brand_id=<?php echo $row->brand_id; ?>"><button type="button" class="btn btn-danger">&nbsp;&nbsp;&nbsp;ลบ&nbsp;&nbsp;</button></a>
                                            </td>
